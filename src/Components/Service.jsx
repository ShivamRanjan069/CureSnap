...
import serv from "../assets/doctor-img02.png"
  ...
  return (
	...
	<div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		<div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
			...
			<img src={serv} alt="" className="object-contain h-72 sm:h-80 lg:h-[400px] xl:h-112 2xl:h-128" />
		...
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            ...
            <br />
			<p className='my-6'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sequi consectetur repellendus unde neque corrupti et quisquam saepe exercitationem quod nostrum autem, placeat praesentium ad nam dignissimos deserunt facilis.</p>
			</p>
