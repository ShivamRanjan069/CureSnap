...
const Footer = () => {
  return (
    <footer className="px-4 divide-y border-b-slate-800x-2 text-gray-800"id='foot'>
	...
	<div className="py-6 text-sm text-center text-gray-600 font-bold">© Design By <span className='text-sky-600'>Shivam </span>. All rights reserved.</div>
</footer>
  )
}
